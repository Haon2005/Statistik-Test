...
import pandas as pd
from pyodide.http import open_url
penguins = pd.read_csv(open_url("https://raw.githubusercontent.com/allisonhorst/palmerpenguins/main/inst/extdata/penguins.csv")).dropna(subset=['bill_length_mm', 'bill_depth_mm'])
