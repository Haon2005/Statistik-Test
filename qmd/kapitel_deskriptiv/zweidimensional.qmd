...
penguins = load_penguins().dropna(subset=['body_mass_g', 'flipper_length_mm'])
...
penguins = load_penguins().dropna(subset=['species', 'island'])
...
penguins = load_penguins().dropna(subset=['body_mass_g', 'flipper_length_mm', 'species'])
